(ns my-day11.core-spec
  (:require [speclj.core :refer :all]
            [my-day11.core :refer :all]))
...
(describe "Solutions"
  (it "will solve problem 1"
    (should= 2093 (count-stable-people (parse-input input))))

  (it "will solve problem 2"
    (should= 1862 (count-stable-visible-people (parse-input input)))))
